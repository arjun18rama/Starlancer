...
You can privately report a vulnerability [here](https://github.com/StarlancerNetwork/starlancer/security/advisories/new).

Alternatively, you can join our [Discord server](https://discord.gg/starlancer), and open a ticket and let us know what the vulnerability is.
...
If you have starlancer installed locally:
